(function () {
  ...
  var gradienSubtractProgram, displayMaterial;
  var baseVertexShader, copyShader, clearShader, splatShader;
  var advectionShader, divergenceShader, curlShader, vorticityShader;
  var pressureShader, gradientSubtractShader, displayShaderSource;
  var blit;
  ...
  function getWebGLContext(cvs) {
    ...
    var glCtx = cvs.getContext('webgl2', params);
    var isWebGL2 = !!glCtx;
  ...
  function init() {
    if (document.getElementById('splash-cursor-canvas')) return;
